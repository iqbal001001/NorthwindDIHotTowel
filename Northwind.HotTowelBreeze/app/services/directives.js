(function () {
    ...
    app.directive('ccImgPerson', ['config', function (config) {
        ...
        var basePath = 'data:image/bmp;base64,';
        ...
        function link(scope, element, attrs) {
            attrs.$observe('ccImgPerson', function (value) {
                ...
                value = value ? basePath + value : unknownImage;
                attrs.$set('src', value);
            });
        }
    }]);
    ...
    app.directive('ccUpload', ['uploadManager', function factory(uploadManager) {
        return {
            restrict: 'A',
    ...
    app.directive("ngFileSelect", ['$rootScope', function ($rootScope) {
